...
<html>
    <head>
        ...
        <link rel="stylesheet" media="screen and (max-width: 450px)" href="mobilestyles.css">
        <link rel="stylesheet" media="screen and (min-width: 451px)" href="desktopstyles.css">
    ...
    <body>
      ...
      <div class="jumbotron jumbotron-fluid">
        <div class="container">
          <button type="button" class="btn btn-primary" href="/betatest.php">Prebid.js Beta Library Test Page</button>
          <button type="button" class="btn btn-primary" href="/prodtest.php">Prebid.js Prod Library Test Page</button>
        </div>
      </div>
